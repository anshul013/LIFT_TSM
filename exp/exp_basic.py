...
class Exp_Basic(object):
    def __init__(self, args):
        ...
        model = self._build_model(None, None)  # Pass None for both parameters
    ...
    def state_dict(self, destination: typing.OrderedDict[str, torch.Tensor]=None,
        ...
        """Returns a dictionary containing a whole state of the module and the state of the optimizer.
    ...
    def load_state_dict(self, state_dict: typing.OrderedDict[str, torch.Tensor], model=None, strict=False) -> nn.Module:
        """Copies parameters and buffers from state_dict into this module and the optimizer.

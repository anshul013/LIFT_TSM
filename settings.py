...
# Models that need x_mark and y_mark inputs
need_x_y_mark = {'Autoformer', 'Transformer', 'Informer', 'LightMTS', 'GPT4TS', 'Crossformer'}

# Models that need only x_mark input
need_x_mark = {'MTGNN', 'PatchTST', 'DLinear', 'Linear', 'NLinear', 'TSMixer', 'LIFTTSMixer'}
